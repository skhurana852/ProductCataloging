...
public class ResultOfSearchByBrand implements ActionListener {
	JScrollPane jScrollPane1,jScrollPane2;
	JFrame frame;
    JMenuItem i1,i2,i4;
    JButton bt,bt1;
	public ResultOfSearchByBrand(String s)
{
		frame=new JFrame();
	...
	String str="select*from product where brand='"+s+"'";
	...
	table.setRowHeight(60); 
	 ...
	 jScrollPane1.setAutoscrolls(true);
      ...
      jScrollPane1.setBounds(220, 96, 850, 300);
	}
	catch(Exception e)
	{
...
{
	new ResultOfSearchByBrand("Nestle");
}
}

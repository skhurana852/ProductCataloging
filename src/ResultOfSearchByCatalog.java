...
public class ResultOfSearchByCatalog implements ActionListener {
	JScrollPane jScrollPane1,jScrollPane2;
	JFrame frame;
	JButton bt,bt1;
	JMenuItem i1,i2,i4;
	public ResultOfSearchByCatalog(String s)
{
		frame=new JFrame();
	...
	String str="select*from product where catalogid='"+s+"'";

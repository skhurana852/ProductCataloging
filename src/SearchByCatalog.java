	...
	public class SearchByCatalog implements ActionListener {	
		...
		public SearchByCatalog()
		{
			...
			lb=new JLabel("Enter Catalog Id:");
			lb.setBounds(450,240,390,60);
		...
		public void actionPerformed(ActionEvent e) {
			if(e.getSource()==bt1)
			{
					...
					new ResultOfSearchByCatalog(str);
					frame.dispose();
			}
